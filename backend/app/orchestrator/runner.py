...
8. 每个核心方向或推进路径的批判审查:必须写最强创新点、最弱证据点、最大可行性风险、与已有基础匹配度、替代路线。
9. 证据链与实验设计:把 Top 方向或当前主路线串成可执行的最小实验包,说明样本/模型/分组/指标/判定标准。
10. 风险、替代路线与收敛条件:指出失败风险、资源瓶颈、阴性结果如何解释,以及何时应转向备选方案。
